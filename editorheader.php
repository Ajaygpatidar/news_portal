<?php
    $lid=$_SESSION['l_id'];
    $cid=$_SESSION['c_id'];
    $sql="SELECT * FROM notification where E_seen='0'and l_id='$lid' and c_id='$cid'";
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right  top-nav">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Editor User <b class="fa fa-angle-down"></b></a>
